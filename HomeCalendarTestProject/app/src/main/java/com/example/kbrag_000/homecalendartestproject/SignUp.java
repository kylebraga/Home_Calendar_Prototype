...
public class SignUp extends AppCompatActivity {
    ...
    private EditText  pass, email, first, last;
    ...
    //testing on Emulator:
    private static final String LOGIN_URL = "http://98.229.0.179:8080/jotwebservice/register.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        first = (EditText)findViewById(R.id.firstName_edittext);
        last = (EditText)findViewById(R.id.lastName_edittext);
        email = (EditText)findViewById(R.id.email_edittext);
        pass = (EditText)findViewById(R.id.password_editext);

        mRegister = (Button)findViewById(R.id.createAccount_button);
